import { ApiResponse, PageResponse } from "./common.schema";
import z from "zod";
...
export const ProductListRes = ApiResponse(PageResponse(ProductSchema));
export type ProductPageListResType = z.TypeOf<typeof ProductListRes>;
